    ...
    for key, value in kwargs.items():
        if key == "selfTrigDelay" :
            ...
            if value:
                ...
                parameters["pre"]="0"
    return ll_message_sender.system_conf_message(serial, **parameters)
...
def radar_frontend_conf_message(serial, **kwargs):
    ...
    return ll_message_sender.radar_frontend_conf_message(serial, **parameters)
        ...
        if key == "pll" :
            if value <= 32767 & value >= -32768 :
                ...
                for i in range (0,(16-len(x))):
                    x = '0' + x
                parameters["pll"]=x
    return ll_message_sender.pll_conf_message(serial, **parameters)
...
def baseband_setup_message(serial, **kwargs):
    ...
    return ll_message_sender.baseband_setup_message(serial, **parameters)
